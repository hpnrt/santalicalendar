...
class Holiday {
	...
	*/
	...
	public function fetchMuluhKunamiUwans ($month, $year) {
		$days = "";
		$type = "";

		// Select Muluh
		$sql = sprintf("SELECT date, muluh, kunami, uwans FROM holiday where year=%d AND month='%s' AND (muluh=1 OR kunami=1 OR uwans=1)",
			$year,  $month);
